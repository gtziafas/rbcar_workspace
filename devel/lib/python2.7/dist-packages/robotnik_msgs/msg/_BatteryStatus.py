...
class BatteryStatus(genpy.Message):
  _md5sum = "86d6d9c22e09e64d16ee579abc60e177"
...
"""
  __slots__ = ['voltage','level','time_remaining']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2fI().pack(_x.voltage, _x.level, _x.time_remaining))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.voltage, _x.level, _x.time_remaining,) = _get_struct_2fI().unpack(str[start:end])
      return self
