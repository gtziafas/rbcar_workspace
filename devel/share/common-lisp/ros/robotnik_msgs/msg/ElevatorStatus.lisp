...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ElevatorStatus>)))
  ...
  "9becbfc724554c6c51b8c09125fe90d4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ElevatorStatus)))
  "Returns md5sum for a message object of type 'ElevatorStatus"
  "9becbfc724554c6c51b8c09125fe90d4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ElevatorStatus>)))
  ...
  (cl:format cl:nil "# state~%string RAISING=raising~%string LOWERING=lowering~%string IDLE=idle~%string ERROR_G_IO=error_getting_io~%string ERROR_S_IO=error_setting_io~%string ERROR_TIMEOUT=error_timeout_in_action~%# position~%string UP=up~%string DOWN=down~%string UNKNOWN=unknown~%# IDLE, RAISING, LOWERING~%string state~%# UP, DOWN, UNKNOWN~%string position~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ElevatorStatus)))
  "Returns full string definition for message of type 'ElevatorStatus"
  (cl:format cl:nil "# state~%string RAISING=raising~%string LOWERING=lowering~%string IDLE=idle~%string ERROR_G_IO=error_getting_io~%string ERROR_S_IO=error_setting_io~%string ERROR_TIMEOUT=error_timeout_in_action~%# position~%string UP=up~%string DOWN=down~%string UNKNOWN=unknown~%# IDLE, RAISING, LOWERING~%string state~%# UP, DOWN, UNKNOWN~%string position~%~%~%"))
